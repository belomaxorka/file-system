 ...
 * @license MIT
 */
class FileCannotRemovedException extends Exception
{
  /**
   * FileCannotRemovedException constructor
   *
  ...
  {
    parent::__construct(
      ($path ? sprintf('File (%s) cannot be removed.', $path) : 'File cannot be removed.')
    );
  }
}
